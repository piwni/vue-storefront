      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 pl20 pr20">
            ...
            <p v-if="OnlineOnly" v-html="this.$t('E-mail us at <b>info@grotesque.store</b> with any questions, suggestions how we could improve products or shopping experience')"/>
