<template>
  ...
  >
    ...
    <div v-if="productsInCart.length" class="summary px40 cl-accent serif">
      ...
      <div v-for="(segment, index) in totals" :key="index" class="row py10" v-if="segment.code !== 'grand_total'">
        <div class="col-xs">
          {{ segment.title }}
      ...
      <div class="row pt30 weight-700 middle-xs" v-for="(segment, index) in totals" :key="index" v-if="segment.code === 'grand_total'">
