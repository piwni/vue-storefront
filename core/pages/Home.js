...
export default {
  ...
  metaInfo () {
    return {
      ...
      meta: this.$route.meta.description ? [{ vmid: 'description', name: 'description', content: this.$route.meta.description }] : [{ vmid: 'description', name: 'description', content: i18n.t('__pagedescription') }]
    }
  }
}
